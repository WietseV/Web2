...
public class TestOverzich {

	private WebDriver driver;
	private MovieDB movieDB = new MovieDB();
	private List<Movie> list = movieDB.getList();
	...
	public void setUp() {
		...
		driver.get("http://localhost:8080/1TX5_VandeputWietse/watchlist");
	}
	...
	@Test
	public void overzichtShowsWholeDataBase() {
